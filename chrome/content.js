...
(function() {
  var apiUrl, decryptLinks, el, elements, encryptText, loadOpenPgp, openpgp, pageContainsCode, triggerRe, _i, _len;
            ...
            return openpgp.encryptMessage(publicKey, message).then(function(encryptedMessage) {
              ...
              return $.ajax({
                beforeSend: function(xhrObj) {
                  return xhrObj.setRequestHeader("Accept", "application/json");
                },
                ...
                success: function(result) {
                  if (result.id != null) {
                    return el.value = "" + apiUrl + "/x/" + result.id;
                  } else {
